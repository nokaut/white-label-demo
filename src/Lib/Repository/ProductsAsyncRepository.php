...
use Nokaut\ApiKit\Repository\ProductsAsyncRepository as ApiKitProductsAsyncRepository;


class ProductsAsyncRepository extends ApiKitProductsAsyncRepository
{
    /**
